...
-- NOTE: This file duplicates infra/bq/sql/create_league_pg_stats_by_season.sql so the
--       ingestion job can bundle the query when only the jobs/ directory is deployed.
